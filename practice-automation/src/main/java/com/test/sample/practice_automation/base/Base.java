...
public class Base {
	...
	public void setupBrowserDriverPath() {
		  WebDriverManager.chromedriver().version(Utilities.getheValueFromPropertiesFile("browser_version")).setup(); //setting up the chrome browser specific driver using web driver manager 
